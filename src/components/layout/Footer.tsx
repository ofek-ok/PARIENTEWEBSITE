...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#040406] border-t border-zinc-800/80 text-zinc-400 pt-16 pb-12 text-right">
      <Container size="default">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-16 border-b border-zinc-800/60">
          {/* Col 1 & 2: Official Pariente Footer Logo & Stars */}
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="flex items-center space-x-3 space-x-reverse pt-1">
              ...
              <a
                ...
                aria-label="אינסטגרם"
                className="w-10 h-10 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-300 hover:text-[#f3c010] hover:border-[#f3c010]/50 transition-all"
              >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm font-medium">
              <li className="flex items-start gap-2.5">
                <MapPin className="w-4 h-4 text-[#f3c010] shrink-0 mt-0.5" />
                <span>{SITE_CONFIG.location.fullAddress}</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-[#f3c010] shrink-0" />
                <a href={`tel:${SITE_CONFIG.contact.phone}`} className="hover:text-white transition-colors">
                  {SITE_CONFIG.contact.phone}
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-[#f3c010] shrink-0" />
            ...
            <div className="pt-2 text-xs text-zinc-500 border-t border-zinc-900">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#f3c010] hover:underline"
              >
